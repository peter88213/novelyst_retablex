...
For creating a message catalog, you download a template with all English messages from [here](https://github.com/peter88213/novelyst_retablex/blob/main/i18n/messages.pot). 
...
Name the binary file **novelyst_retablex.mo**. 


### Install your translation for testing

Add a subdirectory tree to **novelyst/locale**, and place *novelyst_retablex.mo* there, like this:
...
**HINT:** *novelyst_retablex* comes with German translations. Look at the `de` directory tree, if you need an example. 
